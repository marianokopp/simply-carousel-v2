    ...
    const features = [
        {
            ...
            title: 'Sin conocimientos de diseño',
            description: 'La IA se encarga del diseño profesional. Tú solo enfócate en tu mensaje y contenido. No necesitas saber de colores, tipografías ni composición.',
        },
        {
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            description: 'De invertir 2 horas en Canva a tener tu carrusel listo en 3 minutos. Multiplica tu productividad y dedica ese tiempo a lo que realmente importa: tu negocio.',
        },
        {
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            title: 'Resultados profesionales al instante',
            description: 'Templates diseñados por expertos, optimizados para engagement. Cada carrusel se ve como si lo hubiera hecho un diseñador profesional.',
        },
    ];
        ...
        <section id="features" className="bg-white dark:bg-background-dark py-24 border-y border-gray-100 dark:border-gray-800">
            <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
                ...
                <div className="text-center mb-20 space-y-4">
                    <h2 className="text-primary font-bold tracking-widest uppercase text-sm">Por qué Simply Carousel</h2>
                    <h3 className="text-3xl lg:text-5xl font-black tracking-tight text-gray-900 dark:text-white">
                        Diseñado para profesionales, no para diseñadores
                    </h3>
                    <p className="text-gray-700 dark:text-gray-300 max-w-[600px] mx-auto">
                        Sabemos que tu tiempo es valioso. Por eso automatizamos todo el trabajo técnico de diseño.
                    </p>
                </div>
