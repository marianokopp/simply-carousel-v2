    ...
    return (
        <div className="h-full overflow-y-auto p-6 border-r border-gray-200 bg-gray-50">
            <div className="space-y-6">
                ...
                {/* Hook (si existe) */}
                {currentSlide.content.hook && (
                    <div>
                        <label className="block text-xs font-medium text-gray-700 mb-2">
                            Hook
                        </label>
                        <textarea
                            value={currentSlide.content.hook}
                            onChange={(e) => handleContentChange('hook', e.target.value)}
                            rows={3}
                            className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                            placeholder="Hook del slide"
                        />
                    </div>
                )}
                ...
                {currentSlide.content.cta && (
                    <div>
                        ...
                        <input
                            type="text"
                            value={currentSlide.content.cta}
                ...
                {currentSlide.content.number !== undefined && (
                    <div>
                        <label className="block text-xs font-medium text-gray-700 mb-2">
                            Número
                        </label>
                        <input
                            type="text"
                            value={currentSlide.content.number}
